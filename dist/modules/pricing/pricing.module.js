    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: pricing_schema_1.PricingRate.name, schema: pricing_schema_1.PricingRateSchema },
                { name: pricing_schema_1.PlanPricing.name, schema: pricing_schema_1.PlanPricingSchema },
            ]),
        ],
